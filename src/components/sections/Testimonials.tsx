...
import { Quote, User, HeartHandshake } from 'lucide-react'
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-cloud via-white to-cloud px-6 py-24">
      <div className="mx-auto max-w-5xl text-center">
        ...
        {!hasAnyTestimonial && (
          <div className="mx-auto mt-10 flex max-w-md flex-col items-center gap-3 rounded-2xl border border-sky/15 bg-white/60 p-8">
            <HeartHandshake className="size-8 text-sky-deep/60" aria-hidden />
            <p className="font-serif text-lg italic text-ink-soft">
              Les premiers témoignages apparaîtront ici dès qu'ils seront envoyés.
            </p>
          </div>
        )}
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {family.map((testimonial, index) => (
                <motion.figure
                  ...
                  className="flex flex-col items-center rounded-3xl border border-sky/25 bg-white p-8 text-center shadow-[0_14px_35px_-15px_rgba(2,132,199,0.4)] transition-shadow hover:shadow-[0_22px_45px_-15px_rgba(2,132,199,0.5)]"
                >
